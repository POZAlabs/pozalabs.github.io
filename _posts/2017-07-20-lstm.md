...
![LSTM structure](/assets/images/LSTM_MNIST_01.PNG)
...
![LSTM structure](/assets/images/LSTM_MNIST_02.PNG)
...
![LSTM structure](/assets/images/LSTM_MNIST_03.PNG)

1층의 fully connected layer를 이용하여 64차원 벡터를 10차원으로 줄이고 softmax를 이용하여 0부터 9까지 중 하나의 값을 예측합니다.

![LSTM structure](/assets/images/LSTM_MNIST_04.PNG)
